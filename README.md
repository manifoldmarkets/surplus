...
[Apply here](https://airtable.com/appaxqJfxht7OronH/pag3FYwDukcF9syiu/form) — applications due July 10; rolling decisions, so apply soon!
...
*   Research reports like [Elicit](https://elicit.com/) or Deep Research
*   AI forecasting like [Mantic](https://www.mantic.com/) or [Futuresearch](https://futuresearch.ai/)
...
*   Games like [Manifold](https://manifold.markets) or [Universal Paperclips](https://www.decisionproblem.com/paperclips/), teaching concepts through play
...
*   Job platforms like the [80k Job Board](https://jobs.80000hours.org/) or an “AI safety LinkedIn”
    *   Or other opportunities — fellowships, grassroots political coordination
*   Funding platforms like [Manifund](https://manifund.org/) or an open-source [S-process](https://survivalandflourishing.fund/s-process)
    *   Or whitelabeled microgrant platforms like [ACX Grants](https://www.astralcodexten.com/p/apply-for-an-acx-grant-2025) or [Bluedot Rapid Grants](https://bluedot.org/programs/rapid-grants)
    *   Or AI-powered grantmaking and review
*   Writing platforms like [LessWrong](https://www.lesswrong.com/), [EA Forum](https://forum.effectivealtruism.org/), or [Alignment Forum](https://www.alignmentforum.org/)
    *   Or research platforms like [Distill](https://distill.pub/) or [Unjournal](https://www.unjournal.org/)
...
Maybe? We have the most experience on startups with a major software component, but have also built things like [Manifest](https://manifest.is/) and Mox. Apply if you wish!
...
Yes! We can support accepted founders on a J-1 visa, through Mox. See [Mox’s J-1 Global Expert Fellowship](https://www.notion.so/Researchers-and-Founders-Join-Mox-s-J-1-Global-Expert-Fellowship-30d54492ea7a80bc9c5ce70ccfceae07?pvs=21).
